// From https://gist.github.com/DavidKuennen/443121e692175d6fc145e1efb0284ec9
(function (context, trackingId, options) {
  ...
  const track = (type, eventCategory, eventAction, eventLabel, eventValue, exceptionDescription, exceptionFatal) => {
    ...
    const data = serialize({
      ...
      vp:
        options.screenSize && context.visualViewport ? `${(context.visualViewport || {}).width}x${(context.visualViewport || {}).height}` : undefined,
